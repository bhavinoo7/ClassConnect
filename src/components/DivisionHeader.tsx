...
const DivisionHeader = ({ children }: any) => {
  ...
  return (
    <div>
          ...
          <ul className="space-y-2 font-medium mt-7">
            <li>
              ...
              >
                ...
                <span className="ms-3">
                  <button onClick={() => router.replace("/division-dashboard")}>Dashboard</button>
                </span>
              </a>
            </li>
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">
                  <button onClick={() => router.replace("/hod-dash/add-division")}>Attendance</button>
                </span>
              </a>
            </li>
            <li>
              <a
                href="division-dashboard/req"
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
                  className="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            ...
            <li>
              <a
                href="/division-dashboard/time-table"
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
                  className="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 z-30 sm:hidden" onClick={toggleSidebar} />
      )}
