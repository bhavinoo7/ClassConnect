...
const DivisionHeader = ({ children }: any) => {
    ...
    <div>
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          ...
          <ul className="space-y-2 font-medium mt-7">
            <li>
              ...
              >
                ...
                <span className="ms-3">
                  <button onClick={() => router.replace("/division-dashboard")}>
                    Dashboard
                    </button>
                </span>
              </a>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">
                  <button
                    onClick={() => router.replace("/hod-dash/add-division")}
                  >
                    Attendance
                  </button>
                </span>
            ...
            <li>
            <a href="division-dashboard/req" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
          ...
          <li>
             <a href="/division-dashboard/time-table" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap">Time Table</span>
            </a>
         </li> 
            <li>
              <a
